...
os.makedirs('th_11', exist_ok=True)
...
def scrape_layouts(base_type, total_pages):
    ...
    base_url = f'https://clashofclans-layouts.com/plans/th_11/{base_type}_{{}}.html'
    headers = {
    ...
    for page_num in range(1, total_pages + 1):
        ...
        print(
            f"Processing TH11 {base_type} page {page_num}/{total_pages}: {page_url}")
        ...
        try:
            ...
            expected_img_path = f"/pics/th11_plans/{base_type}/original/th11_{base_type}_{page_num}.jpg"
            ...
            if a_tag and a_tag.find('img'):
                ...
                file_path = f"th_11/th11_{base_type}_{page_num}.jpg"
...
# Scrape TH11 war layouts
print("Starting to scrape Town Hall 11 layouts...")
war_downloads = scrape_layouts('war', 130)

print(
    f"All scraping complete. Downloaded {war_downloads} TH11 images in total.")
