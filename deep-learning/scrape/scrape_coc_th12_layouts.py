...
os.makedirs('th_12', exist_ok=True)
...
def scrape_layouts(base_type, total_pages):
    ...
    base_url = f'https://clashofclans-layouts.com/plans/th_12/{base_type}_{{}}.html'
    headers = {
    ...
    for page_num in range(1, total_pages + 1):
        ...
        print(
            f"Processing TH12 {base_type} page {page_num}/{total_pages}: {page_url}")
        ...
        try:
            ...
            expected_img_path = f"/pics/th12_plans/{base_type}/original/th12_{base_type}_{page_num}.jpg"
            ...
            if a_tag and a_tag.find('img'):
                ...
                file_path = f"th_12/th12_{base_type}_{page_num}.jpg"
...
# Scrape TH12 war layouts
print("Starting to scrape Town Hall 12 layouts...")
war_downloads = scrape_layouts('war', 130)

print(
    f"All scraping complete. Downloaded {war_downloads} TH12 images in total.")
