...
os.makedirs('th_17', exist_ok=True)
...
def scrape_layouts(base_type, total_pages):
    ...
    base_url = f'https://clashofclans-layouts.com/plans/th_17/{base_type}_{{}}.html'
    headers = {
    ...
    for page_num in range(1, total_pages + 1):
        ...
        print(
            f"Processing {base_type} page {page_num}/{total_pages}: {page_url}")
        ...
        try:
            ...
            expected_img_path = f"/pics/th17_plans/{base_type}/original/th17_{base_type}_{page_num}.jpg"
            ...
            if a_tag and a_tag.find('img'):
                ...
                file_path = f"th_17/th17_{base_type}_{page_num}.jpg"
...
# Scrape war and farm layouts
# war_downloads = scrape_layouts('war', 100)
farm_downloads = scrape_layouts('farm', 33)

print(
    f"All scraping complete. Downloaded {war_downloads + farm_downloads} images in total.")
